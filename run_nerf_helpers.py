...
class NeRF_d(nn.Module):
    def __init__(self, D=8, W=256, input_ch=3, input_ch_views=3, output_ch=4, skips=[4], use_viewdirsDyn=True, img_fea_ch=None,):
        """
        """
    ...
    def forward(self, x, f_projection=None):
...
def create_nerf(args):
    ...
    def network_query_fn_d(inputs, viewdirs, network_fn, f_projection):
        return run_network(
    ...
    def network_query_fn_s(inputs, viewdirs, network_fn, f_projection): return run_network(
        inputs, viewdirs, network_fn,
        embed_fn=embed_fn_s,
        embeddirs_fn=embeddirs_fn,
        netchunk=args.netchunk,
